...
## 개미
개미가 대각선으로 벽에 튕기며 움직인다. 일정 시간이 지난 뒤 개미의 좌표를 구하는 문제

개미의 좌표값에 규칙을 찾았다

대각석으로 움직이기 때문에 가로의 좌표와 세로의 좌표를 따로 생각하여 문제를 풀었다.


## 답안지 채점
정답표와 학생들의 답안을 비교하여 점수를 구하는 문제

누적합이 섞여있는 문제다.

채점지라는 리스트를 만들어 학생들의 점수를 구했다.

리스트를 만들지 않고 바로 구하는 방법도 있다. 